...
public class ConnectionManager {
	...
	private static final String URL = "jdbc:mysql://localhost:3306/tv_tracker";
	private static final String USERNAME = "root";
	private static final String PASSWORD = "@Cantukani9"; // change password if needed, Mac/Linux = Root@123  |  Windows = root
